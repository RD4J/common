...
/**
 * 消息格式化工具 <br>
 * source code: org.slf4j.helpers.MessageFormatter
 *
...
public final class MessageFormatter {
    ...
    /**
     * 使用{}占位符作为字符串填充 <br>
     * 不会对object进行序列化, 序列化需要自行处理 <br>
     *
     * @param messagePattern 待填充字符串
     * @param argArray       填充的对象数组
     * @return 格式化字符串
     */
    public static final String format(String messagePattern, Object... argArray) {
        ...
        if (Check.isNullOrEmpty(messagePattern)) {
            return messagePattern;
        }
        int i = 0;
        int j;
